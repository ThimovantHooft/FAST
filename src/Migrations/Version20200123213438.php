 ...
 */
final class Version20200123213438 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(30) NOT NULL, ADD password VARCHAR(255) NOT NULL, ADD age INT DEFAULT NULL, ADD is_active TINYINT(1) NOT NULL, DROP name, CHANGE email email VARCHAR(255) NOT NULL, CHANGE tel tel INT DEFAULT NULL, CHANGE points points INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD name VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP username, DROP password, DROP age, DROP is_active, CHANGE email email VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE tel tel INT NOT NULL, CHANGE points points INT DEFAULT NULL');
